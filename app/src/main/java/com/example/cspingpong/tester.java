...
class tester
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Now that we have a server, let's get a list of all games of a given day.\n" +
                "let's say we want all games of 23/11/2019. We do that using getDayAgenda method.\n" +
                "We will get an ArrayList of Game objects.");
        ArrayList<Game> games_by_day = server.getDayAgenda(23112019);
        ...
        System.out.println("Okay. So we know how to get a list of games of a specific date, and we know how to join " +
                ...
                "We can use the getHourAgenda method.");
        ArrayList<Game> games_by_hour = server.getHourAgenda(23112019, 0);
...
//        server.saveState();
//        games_a_day = server.getGamesByDate(22122019);
